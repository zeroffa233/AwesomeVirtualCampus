...
public class LibraryReturnBookViewController {
    ...
    private GridPane createTransactionNode(LibraryTransaction transaction) {
        ...
        borrowContent.setStyle("-fx-underline: true;");
        ...
        dueContent.setStyle("-fx-underline: true;");
        ...
        HBox actionBox = new HBox(10, renewButton, returnButton);
        actionBox.setAlignment(Pos.CENTER_RIGHT);
        grid.add(actionBox, 0, 2, 4, 1);

        Label feedbackLabel = new Label();
        grid.add(feedbackLabel, 0, 3, 4, 1);
